      ...
      <div class="modal-body">
        ...
        if (isset($_GET['id'])) {
          ...
          if ($rowdb) {
            ...
            echo "Overtime: " . "<input type=text name = EmpOver disabled value='$rowdb[3]'> <br>";
            echo "Deduction: " . "<input type=text name = EmpDec disabled value='$rowdb[4]'> <br>";
            echo "Basic Rate: " . "<input type=text name= EmpBR disabled value='$rowdb[5]'> <br>";
     
            echo "<input type=hidden name='Empt_delID' value='$id'><br>";
            echo "<input type=submit name='ans' value='No'class= 'Buttons'>";
            echo "<input type=submit name='dELETE' value='Yes' class= 'Buttons'></form>";
